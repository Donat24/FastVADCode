...
#TrainClass
class DNN_DNN_GRU_SPCEN_CC_ModelTrain(VADLightningBase):
    def __init__(self,
            frame_size              = None,
            sr                      = None,
            n_cc                    = 20,
        ...
        #GRU
        self.gru = nn.GRU(
                input_size    = hidden_size_layer_2[-1],
        ...
        #MLP
        self.mlp_out = MLP(
            in_channels     = hidden_size_gru,
            hidden_channels = [hidden_size_gru, 1],
            norm_layer      = None
        )
...
class DNN_DNN_GRU_SPCEN_CC_Model(nn.Module):
    def __init__(self,
        frontend                = None,
    ...
    def forward(self, x : Tensor, m_last_frame : Optional[Tensor], layer_1_context : Optional[Tensor] = None, layer_2_context : Optional[Tensor] = None, h_context : Optional[Tensor] = None) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
        ...
        #Return
        return out.flatten(), m_last_frame, layer_1_context, layer_2_context, h_context

def to_script(model:DNN_DNN_GRU_SPCEN_CC_ModelTrain):
    ...
    model = DNN_DNN_GRU_SPCEN_CC_Model(
